# 业务项目内研发 5 阶段契约模板 (DEC-2026-0002 + DEC-2026-0003)
...
**关键 (DEC-2026-0003)**:
- 5 阶段 agent **物理位置在业务项目内** (`biz-projects/<biz_project_id>/eng-roles/`)
- 业务项目从 `PMO/templates/eng-roles/` 复制模板, 然后按业务调整实施
- PMO **不实施** 5 阶段 agent, 只监督
